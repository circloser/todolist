...
export default function ManualContent() {
  return (
    <div className="space-y-5">
      ...
      <Section icon="🏢" title="부서/팀 보드와 암호">
        <p>
          상단 <Key>부서 / 팀</Key>에서 현재 사용할 보드를 선택합니다. 다른
          부서나 팀의 보드가 잠겨 있으면 암호 입력 화면이 먼저 표시되고, 암호를
          통과해야 업무 목록·지도·보고서를 볼 수 있습니다.
        </p>
        <p>
          새 부서/팀은 상단의 <Key>새 부서명</Key> <Key>새 팀명</Key>{" "}
          <Key>암호</Key> 입력칸으로 추가합니다. 암호는 4자 이상이어야 하며,
          입력한 암호는 현재 브라우저 세션에만 기억됩니다.
        </p>
        <p>
          현재 보드의 부서명, 팀명, 새 암호는 화면 하단{" "}
          <strong>보드 설정</strong>의 <Key>현재 부서/팀</Key> 영역에서 변경합니다.
          암호 칸을 비워 두고 저장하면 이름만 변경됩니다.
        </p>
      </Section>
      ...
      <Section icon="💡" title="운영 팁">
        ...
        <p>
          · 업무 데이터는 선택한 부서/팀 보드별로 나뉘어 팀 공용 서버에
